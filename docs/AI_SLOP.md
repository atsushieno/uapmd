...
- The DAG design and implementation is AI-driven code.
- We introduced realtime safety on their audio processing and it was mostly AI-driven code.

## uapmd-addin-core

- The entire module is AI-generated code. Human only gave the basic design and some API details.
...
- audio warp is mostly done by AI. Human only gave the basic structure and requirements.
- Throughout undo/redo support implementation, it has involved a lot of AI-written code (as well as uapmd-engine).
...
- Throughout undo/redo support implementation, it has involved a lot of AI-written code (as well as uapmd-data).

## uapmd-app-model and uapmd-app
...
- The entire code is generated by AI. It is designed to be an implementation of our document event API which was partly generated by AI by understanding the required event model in ARA_API too.
