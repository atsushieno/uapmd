...
namespace uapmd {
    ...
    PlatformVirtualMidiDevice::PlatformVirtualMidiDevice(std::string& apiName, std::string& deviceName, std::string& manufacturer, std::string& version, uint64_t sysexDelayInMicroseconds)
        : impl(new Impl(apiName, deviceName, manufacturer, version, sysexDelayInMicroseconds)) {
    }
