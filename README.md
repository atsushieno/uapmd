...
This directory contains the static site files intended for the `gh-pages` branch.
...
from `cmake-build-wasm/source/tools/uapmd-app/` into `gh-pages/playground/latest/`.
At minimum, this normally includes `uapmd-app.js`, `uapmd-app.wasm`, and any
additional files emitted next to them by Emscripten.
