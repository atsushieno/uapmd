...
namespace uapmd {
    ...
    class AudioPluginSequencer {
        ...
        std::unordered_map<int32_t, AudioPluginNodePAL*> plugin_instances_;
        ...
        void registerParameterListener(int32_t instanceId, AudioPluginNodePAL* node);
    ...
    public:
        ...
        AudioPluginNodePAL* getPluginInstance(int32_t instanceId);
