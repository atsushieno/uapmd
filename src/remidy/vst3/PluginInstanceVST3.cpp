...
void remidy::AudioPluginInstanceVST3::deallocateProcessData() {
...
void remidy::AudioPluginInstanceVST3::inspectBuses() {
    BusSearchResult ret{};
...
const std::vector<remidy::AudioBusConfiguration*>& remidy::AudioPluginInstanceVST3::audioInputBuses() const { return input_buses; }

const std::vector<remidy::AudioBusConfiguration*>& remidy::AudioPluginInstanceVST3::audioOutputBuses() const { return output_buses; }
