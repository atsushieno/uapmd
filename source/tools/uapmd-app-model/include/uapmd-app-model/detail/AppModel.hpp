...
namespace uapmd_app {
    ...
    public:
        ...
        bool isAudioEngineEnabled() const { return audioEngineEnabled_.load(std::memory_order_acquire) && sequencer_.engine()->audioWorkers().fault() == uapmd::AudioWorkerFault::None; }
