// Emscripten detects AudioWorklet context via !!globalThis.AudioWorkletGlobalScope.
...
if (typeof registerProcessor === 'function') {
    ...
    // runtime executes inside the worklet.  The shim intentionally mirrors the subset
    // of Navigator that Emscripten touches and reports "unsupported" for features that
    // are not allowed on the audio thread instead of faking success.
